...
app.post('/user_home_customer',(req,res)=>{
    ...
    if (req.body.action==="view_my_flights"){
        ...
        const query = `SELECT SUM(f.price) as total_spending_in_the_past_year
        FROM purchases as p, ticket as t, flight as f
        WHERE p.ticket_id = t.ticket_id AND t.airline_name = f.airline_name AND t.flight_num = f.flight_num 
        ...
        con.query(query,(error,results)=>{
            if (error){
                ...
                res.render('customer_track_spending',{total_spending_in_the_past_year:results[0].total_spending_in_the_past_year})
            }
        })
...
app.post('/customer_track_spending',(req,res)=>{
