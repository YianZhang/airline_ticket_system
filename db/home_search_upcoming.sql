...
INSERT INTO purchases VALUES (@ticket_id, '${req.session.data.email}', NULL, NOW());
-- else if user type = "agent":
INSERT INTO purchases VALUES (@ticket_id, '${req.body.purchase_ticket_for_customer}', '${req.session.data.booking_agent_id}', NOW());
-- else
