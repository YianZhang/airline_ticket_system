...
t.airline_name = (SELECT airline_name FROM airline_staff WHERE username = ${lemonade.username})
AND p.purchase_date >= ${watermelon.start_date} AND p.purchase_date <= ${watermelon.end_date}
